...
ops.fbinary             = fullfile(fPath, filename); % will be created for 'openEphys'		
ops.fproc               = fullfile(fPath, 'temp_wh.dat'); % residual from RAM of preprocessed data	
ops.root                = savepath; % 'openEphys' only: where raw files are		
...
ops.chanMap             = 'C:\Users\cooper_PC\Desktop\GitHub repositories\cooperAnalysis\matlabCode\operantMatching\kilosort_opMD\chanMap.mat'; % make this file using createChannelMapFile.m		

function [LH, probChoice, Q_s, Q_l, pe_s, pe_l] = qLearningModel_dual_oneForget_2start(startValues, choice, outcome, ITI)
...
beta = startValues(6);
Q_l_start_L = startValues(7);
Q_l_start_R = startValues(7);

trials = length(choice);
Q_s = zeros(trials,2);
Q_l = [Q_l_start_L Q_l_start_R; zeros(trials-1,2)];

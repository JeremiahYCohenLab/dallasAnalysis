function [LH, probChoice, Q_s, Q_l, Q, pe_s, pe_l] = qLearningModel_dual_tau_noForget(startValues, choice, outcome, ITI)

alphaNPE_s = startValues(1);
alphaPPE_s = startValues(2);
alphaNPE_l = startValues(3);
alphaPPE_l = startValues(4);
beta = startValues(5);
tau = startValues(6);

function [fit, samples] = stan_qLearning_fitOpponency(xlFile, animal, category, revForFlag)
...
fit = stan('file','stan_qLearning_5params_opponency.stan','data',session_dat,'verbose',true);

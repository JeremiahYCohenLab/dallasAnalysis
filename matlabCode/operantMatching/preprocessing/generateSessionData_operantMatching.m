function [sessionData, blockSwitch] = generateSessionData_operantMatching(sessionName)
...
save([savepath sessionName '_sessionData_behav.mat'], 'sessionData', 'blockSwitch');
end
